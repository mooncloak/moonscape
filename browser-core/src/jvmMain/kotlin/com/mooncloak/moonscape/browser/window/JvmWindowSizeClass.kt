...
public actual fun calculateWindowSizeClass(): WindowSizeClass {
    ...
    return WindowSizeClass(
        widthSizeClass = when (windowSize.widthSizeClass) {
            WindowWidthSizeClass.Compact -> com.mooncloak.moonscape.browser.window.WindowWidthSizeClass.Compact
            WindowWidthSizeClass.Medium -> com.mooncloak.moonscape.browser.window.WindowWidthSizeClass.Medium
            else -> com.mooncloak.moonscape.browser.window.WindowWidthSizeClass.Expanded
        },
        heightSizeClass = when (windowSize.heightSizeClass) {
            WindowHeightSizeClass.Compact -> com.mooncloak.moonscape.browser.window.WindowHeightSizeClass.Compact
            WindowHeightSizeClass.Medium -> com.mooncloak.moonscape.browser.window.WindowHeightSizeClass.Medium
            else -> com.mooncloak.moonscape.browser.window.WindowHeightSizeClass.Expanded
        }
    )
}
